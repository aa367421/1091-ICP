...
{
    public GameObject Player , Bullet;      //載入玩家物件和子彈物件、音效
    ...
    void Update()
    {
        ...
        if(Input.GetKey(KeyCode.Space) && (ShootDelay == 0))       //按下空格鍵且ShootDelay值=Delay值，射擊
        {
    ...
    public void Die()   //死亡狀態，同時可被TopDownWallFuntion呼叫，當敵人與下方遊戲畫面碰撞時飛船死亡
    {
       HP = 0;
       speed = 0;
