...
{   
    ...
    public int KillCount = 0;       //載入擊墜敵人數量、遊戲結束頁
    public AudioSource BoomSound;
    public GameObject GoodText , OverTitle , ReButton , ReText , ExitButton , ExitText;
    ...
    public void GameTutor()     //教學頁狀態UI設定
    {
        IsTutoring = true;
    ...
    public void GameStart()     //遊戲狀態UI設定
    {   
        IsTutoring = false;
    ...
    {   
        ...
        if (SpaceCount == 2)    //進入遊戲狀態，同時讓SpaceCount增加，讓這個條件不重複被觸發
        {
            GameStart();
            SpaceCount += 1;
        }            
    ...
    public void Succeed()   //通關函式，在通關後一小段間隔跳出通關文字
    {
        t += Time.deltaTime;
    ...
    public void Restart()   //重啟遊戲函式
    {
        SceneManager.LoadScene(0);
    }

    public void QuitGame()  //離開程式函式
    {
        Application.Quit();
    }
}
